...
generateComment = (score) => {
  let comment = "";
  if (score < 25) {
    comment = "Did you even watch Naz's video?";
  } else if (score < 50) {
    comment = "Schedule a call with a CP success coach";
  } else if (score < 70) {
    comment = "You are on fire! Don't stop now.";
  } else if (score < 85) {
    comment = "This beat is so good, Naz started dancing!";
  } else if (score < 100) {
    comment = "You are definitely ready for the Profitable Shortcut!";
  } else {
    comment = "nice. I'll see YOU!... in the next round.";
  }
  return comment;
}
