...
writeTutorial = () => {
    ...
    let i = 0;
    const tutorialTexts = ["Think you have what it takes to take on the number 1 beatboxJS champion in the world? warm-up and play around with the pad on the left side: - Click on the squares to add notes. Click on 'Play' to play the music. Change the tempo with the selector.", "When you think you're ready to take me on, press 'Start The Round'"];
    const speed = 70;
